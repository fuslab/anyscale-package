...
Name: anyscale-parcel-%{anyscale_parcel_base_version}
Version: %{anyscale_parcel_version}
Release: %{anyscale_parcel_release}
Summary: All the server side CDH java bits in one relocatable package

Group:		Applications/Engineering
License:	APL2
URL:		http://fusionlab.cn
Source0:        anyscale-parcel-%{anyscale_parcel_patched_version}.tar.gz
