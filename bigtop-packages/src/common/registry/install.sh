...
usage: $0 <options>
  ...
  Optional options:
     --lib-dir=DIR               path to install Registry home [/usr/[stack_name]/[stack_version]/registry/lib]
     --stack-home=DIR            path to install dirs [/usr/[stack_name]/[stack_version]/registry]
...
install -d -m 0755 $PREFIX/$STACK_HOME/$COMPONENT_NAME/bootstrap
...
cp -a ${BUILD_DIR}/bootstrap/* $PREFIX/$STACK_HOME/$COMPONENT_NAME/bootstrap/

cp -a ${BUILD_DIR}/{LICENSE.txt,NOTICE.txt,README.md} ${PREFIX}/${LIB_DIR}/
