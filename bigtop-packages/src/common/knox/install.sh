...
usage: $0 <options>
  ...
  Optional options:
     --lib-dir=DIR               path to install knox home [/usr/[stack_name]/[stack_version]/knox/lib]
     --stack-home=DIR            path to install dirs [/usr/[stack_name]/[stack_version]/knox]
...
cp -a ${BUILD_DIR}/* $PREFIX/$STACK_HOME/$COMPONENT_NAME/
rm -rf $PREFIX/$STACK_HOME/$COMPONENT_NAME/logs
