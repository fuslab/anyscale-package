...
usage: $0 <options>
  ...
  Optional options:
     --lib-dir=DIR               path to install presto home [/usr/[stack_name]/[stack_version]/presto/lib]
     --stack-home=DIR            path to install dirs [/usr/[stack_name]/[stack_version]/presto]
...
# generate presto install package
echo `pwd`
