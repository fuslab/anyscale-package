...
usage: $0 <options>
  ...
  Optional options:
     --lib-dir=DIR               path to install Streamline home [/usr/[stack_name]/[stack_version]/streamline/lib]
     --stack-home=DIR            path to install dirs [/usr/[stack_name]/[stack_version]/streamline]
...
cp -a ${BUILD_DIR}/{LICENSE,NOTICE,README.md} ${PREFIX}/${LIB_DIR}/
